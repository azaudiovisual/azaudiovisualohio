      ...
      <ContactContainer>
        ...
        <ContactContent>
          ...
          >
            ...
            <ContactInfoItem>
              <ContactInfoIcon as="a" href="tel:+13304194411" style={{ display: 'flex', color: 'inherit', textDecoration: 'none' }}>
              ...
              <ContactInfoText>
                ...
                <ContactInfoValue as="a" href="tel:+13304194411" style={{ color: 'inherit', textDecoration: 'none' }}>(330)-419-4411</ContactInfoValue>
              </ContactInfoText>
            </ContactInfoItem>
            
            <ContactInfoItem>
              <ContactInfoIcon as="a" href="mailto:azaudiovisualohio@gmail.com" style={{ display: 'flex', color: 'inherit', textDecoration: 'none' }}>
                <svg viewBox="0 0 24 24" fill="#FFFFFF">
